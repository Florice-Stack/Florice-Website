...
const productAccents: Record<string, { barFrom: string; barTo: string }> = {
  "flour-mill": { barFrom: "#d4bc8a", barTo: "#f5efe3" },
  "rice-mill": { barFrom: "#b8d4c4", barTo: "#edf3f0" },
  "pulse-plant": { barFrom: "#8a7a94", barTo: "#f0ebf4" },
  "besan-plant": { barFrom: "#f0d9b8", barTo: "#fef3e8" },
  "dalia-machine": { barFrom: "#c5cdd8", barTo: "#eef1f4" },
  "energy-food": { barFrom: "#f5c2d4", barTo: "#fce8ef" },
};
...
export default function MachineryProductsGrid({ products }: MachineryProductsGridProps) {
  return (
    <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
      {products.map((product) => {
        const accent = productAccents[product.id] ?? productAccents["flour-mill"];
